...
This is the C# version. We also have a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_IsisAcquisitionDemo_VB_x86) available.  
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_IsisAcquisisionDemo_CS_x86.git IsisAcquisitionDemo
```
